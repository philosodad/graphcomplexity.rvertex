...
#        mtcruns = mtcruns / (x - mtcfail).to_f
  ...
  def print_to_file
    File.open("experiment7h_av.tab", 'w') {|x|
    ...
    File.open("experiment7h_fr.tab", 'w') {|x|
    ...
    File.open("experiment7h_rn.tab", 'w') {|x|
    ...
    File.open("experiment7h_fa.tab", 'w') {|x|
